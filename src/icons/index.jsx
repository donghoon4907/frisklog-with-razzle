...
export const HeartEmpty = ({ style }) => (
  <img src={require("./img/heart.png")} alt="like icon" style={style} />
);
...
export const HeartFull = ({ style }) => (
  <img src={require("./img/heart_full.png")} alt="like icon" style={style} />
);
...
export const Comment = ({ style }) => (
  <img src={require("./img/comment.png")} alt="comment icon" style={style} />
);
...
export const View = ({ style }) => (
  <img src={require("./img/eye.png")} alt="view icon" style={style} />
);
...
export const Trash = ({ style }) => (
  <img src={require("./img/trash.png")} alt="trash icon" style={style} />
);
...
export const Modify = ({ style }) => (
  <img src={require("./img/modify.png")} alt="modify icon" style={style} />
);
...
export const Notice = ({ style }) => (
  <img src={require("./img/speaker.png")} alt="notice icon" style={style} />
);
